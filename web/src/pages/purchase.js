      ...
      <section>
        ...
        <div className="grid lg:grid-cols-12 h-screen">
          <div className="lg:col-start-1 lg:col-span-3 bg-primary-50 py-12 lg:pt-32 lg:pb-12 lg:px-10 hidden lg:flex justify-between items-start flex-col">
            <div>
              <p className="text-sm">
                Let’s get the ball rolling so you can buy a home! We’re ready to
                find you the best rates and match you to the right loan. We have
                a few basic questions to help us get started. Or, if you’d like
                immediate assistance, please give us a call at{" "}
                <a
          ...
          <div className="lg:col-end-13 lg:col-span-9 py-8 lg:py-12 px-4 lg:px-20 mt-14 lg:mt-0">
