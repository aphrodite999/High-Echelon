  ...
  return (
    <Layout headerDarkMode={true}>
      <SearchEngineOptimization
        title="De Plaines Mortgage Lender | Home Loans | MacAsh"
        description="Apply online. Close in 15 days. It's that easy. Make your dream home a reality with MacAsh, your independent mortgage broker in De Plaines and northern Illinois."
          ...
          <div className="grid md:grid-cols-12 gap-y-8 md:gap-x-10 lg:gap-x-16 items-center">
            <div className="md:col-start-1 md:col-span-7">
              <GatsbyImage
                ...
                alt="Des Plaines Home Loans"
              />
            </div>
            <div className="md:col-end-13 md:col-span-5">
              <h1>Des Plaines Home Loans</h1>
              <p className="font-display italic text-xl md:text-2xl">
                ...
                lender in Des Plaines and northern Illinois.
              </p>
              <ButtonGhost
                href="/about/"
                text="Learn More"
            ...
            <div className="md:mt-10 lg:mt-28">
              <div>
                ...
                <p className="font-display italic text-lg md:text-2xl">
                  ...
                  in Des Plaines, get started with MacAsh. We make it quick and
                  easy.
                </p>
                <div>
                  <ButtonGhost
      ...
      <section className="mb-20 md:mb-32">
        <div className="container">
          <div className="grid md:grid-cols-2 gap-y-8 md:gap-x-10 lg:gap-x-20 items-center">
            <div>
              <h2>The Des Plaines Life</h2>
              <p className="mb-0">
                At MacAsh, we make our home in northern Illinois and are proud
                to be a local mortgage broker in Des Plaines. This Chicago
                suburb is a vibrant area filled with affordable homes and
                beautiful green spaces along the banks of the Des Plaines River.
                The city is also the home of the original McDonald's and holds a
                claim to fame as the filming location for the 1980s movie "The
                Breakfast Club" ( which was shot inside a high school that had
                shut down a few years prior). Des Plaines is a great place to
...
export const query = graphql`
  {
    ...
    city: file(relativePath: { eq: "cities/De Plaines.jpg" }) {
      childImageSharp {
        gatsbyImageData(layout: CONSTRAINED, width: 560)
      }
    }
