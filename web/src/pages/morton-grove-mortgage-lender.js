  ...
  return (
    <Layout headerDarkMode={true}>
      <SearchEngineOptimization
        title="Morton Grove Mortgage Lender | Home Loans | MacAsh"
        description="Apply online. Close in 15 days. It's that easy. Make your dream home a reality with MacAsh, your independent mortgage broker in Morton Grove and northern Illinois."
          ...
          <div className="grid md:grid-cols-12 gap-y-8 md:gap-x-10 lg:gap-x-16 items-center">
            <div className="md:col-start-1 md:col-span-7">
              <GatsbyImage
                ...
                alt="Morton Grove Home Loans"
              />
            </div>
            <div className="md:col-end-13 md:col-span-5">
              <h1>Morton Grove Home Loans</h1>
              <p className="font-display italic text-xl md:text-2xl">
                ...
                lender in Morton Grove and northern Illinois.
              </p>
              <ButtonGhost
                href="/about/"
                text="Learn More"
          ...
          <div className="grid md:grid-cols-2 gap-y-8 md:gap-x-10 lg:gap-x-20">
            <div className="md:mt-10 lg:mt-28">
              <div>
                ...
                <p className="font-display italic text-lg md:text-2xl">
                  Apply online. Close in 15 days. It really is that easy. Make
                  your dream home a reality with MacAsh, your independent
                  mortgage lender in Morton Grove and northern Illinois.
                </p>
                <div>
                  <ButtonGhost
                    href="/home-purchase/"
      ...
      <section className="mb-20 md:mb-32">
        <div className="container">
          <div className="grid md:grid-cols-2 gap-y-8 md:gap-x-10 lg:gap-x-20 items-center">
            <div>
              <h2>The Morton Grove Life</h2>
              <p className="mb-0">
                At MacAsh, we make our home in northern Illinois and are proud
                to be a local mortgage broker in Morton Grove. If you choose to
                make your home in Morton Grove, you'll love the close-knit
                community of this Chicago suburb, its local retail and
                restaurant scene, and easy commuter options. You'll also have
                access to the Forest Preserves of Cook County, where you can
                explore 70,000 acres of open spaces. Morton Grove is a great
                place to put your roots down, and we're happy to help you land
                your dream home here in Illinois.
              </p>
            </div>
            <div>
              <GatsbyImage
                image={data.city.childImageSharp.gatsbyImageData}
                alt="The Morton Grove Life"
              />
            </div>
          </div>
        </div>
...
export const query = graphql`
  {
    ...
    city: file(relativePath: { eq: "cities/Morton Grove.jpg" }) {
      childImageSharp {
        gatsbyImageData(layout: CONSTRAINED, width: 560)
      }
    }
