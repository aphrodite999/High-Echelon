  ...
  return (
    <Layout headerDarkMode={true}>
      <SearchEngineOptimization
        title="Park Ridge Mortgage Lender | Home Loans | MacAsh"
        description="Apply online. Close in 15 days. It's that easy. Make your dream home a reality with MacAsh, your independent mortgage broker in Park Ridge and northern Illinois."
          ...
          <div className="grid md:grid-cols-12 gap-y-8 md:gap-x-10 lg:gap-x-16 items-center">
            <div className="md:col-start-1 md:col-span-7">
              <GatsbyImage
                ...
                alt="Park Ridge Home Loans"
              />
            </div>
            <div className="md:col-end-13 md:col-span-5">
              <h1>Park Ridge Home Loans</h1>
              <p className="font-display italic text-xl md:text-2xl">
                ...
                lender in Park Ridge and northern Illinois.
              </p>
              <ButtonGhost
                href="/about/"
                text="Learn More"
            ...
            <div className="md:mt-10 lg:mt-28">
              <div>
                ...
                <p className="font-display italic text-lg md:text-2xl">
                  ...
                  in Park Ridge, get started with MacAsh. We make it quick and
                  easy.
                </p>
                <div>
                  <ButtonGhost
      ...
      <section className="mb-20 md:mb-32">
        <div className="container">
          <div className="grid md:grid-cols-2 gap-y-8 md:gap-x-10 lg:gap-x-20 items-center">
            <div>
              <h2>The Park Ridge Life</h2>
              <p className="mb-0">
                At MacAsh, we make our home in northern Illinois and are proud
                to be a local mortgage broker in Park Ridge. This Chicago suburb
                has a small town, neighborly vibe with the excitement of the big
                city just a hop, skip, and a jump away. It's also the childhood
                home of Hillary Rodham Clinton, former United States Secretary
                of State. Park Ridge is a great place to put your roots down,
...
export const query = graphql`
  {
    ...
    city: file(relativePath: { eq: "cities/Park Ridge.jpg" }) {
      childImageSharp {
        gatsbyImageData(layout: CONSTRAINED, width: 560)
      }
    }
