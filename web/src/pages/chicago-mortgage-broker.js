  ...
  return (
    <Layout headerDarkMode={true}>
      <SearchEngineOptimization
        title="Chicago Mortgage Broker | MacAsh Home Loans"
        description="Apply online. Close in 15 days. It's that easy. Make your dream home a reality with MacAsh, your independent mortgage broker in Chicago and northern Illinois."
          ...
          <div className="grid md:grid-cols-12 gap-y-8 md:gap-x-10 lg:gap-x-16 items-center">
            ...
            <div className="md:col-end-13 md:col-span-5">
              ...
              <p className="font-display italic text-xl md:text-2xl">
                ...
                broker in Chicago and northern Illinois.
              </p>
              <ButtonGhost
                href="/about/"
                text="Learn More"
          ...
          <div className="grid md:grid-cols-2 gap-y-8 md:gap-x-10 lg:gap-x-20">
            <div className="md:mt-10 lg:mt-28">
              <div>
                <h2>Ready To Buy?</h2>
                <p className="font-display italic text-lg md:text-2xl">
                  With our fast, simple, and affordable process, we will get you
                  in your dream home in record time, completely online and at an
                  unbeatable price.
                </p>
                <div>
                  <ButtonGhost
      ...
      <section className="mb-20 md:mb-32">
        <div className="container">
          <div className="grid md:grid-cols-2 gap-y-8 md:gap-x-10 lg:gap-x-20 items-center">
            <div>
              <h2>The Chicago Life</h2>
              <p className="mb-0">
                At MacAsh, we make our home in northern Illinois and are proud
                to be a local mortgage broker and lender. We love the city of
                Chicago and its surrounding communities. From the beautiful
                shores of Lake Michigan to deep-dish pizza and Chicago-style hot
                dogs (and, of course, fiercely loyal sports fans), life is good
                in the Chicago area. It’s a great place to put your roots down,
                and we’re happy to help you land your dream home here in
                Illinois.
              </p>
            </div>
            <div>
...
export const query = graphql`
  {
    ...
    city: file(relativePath: { eq: "cities/chicago.jpg" }) {
      childImageSharp {
        gatsbyImageData(layout: CONSTRAINED, width: 560)
      }
    }
