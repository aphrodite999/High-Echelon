  ...
  const faqs = [
    {
      ...
      answer: (
        <>
          <p>
            You're eligible if you completed at least six years of honorable
            service, are on active duty (for at least 90 days), or were
            discharged with a disability related to your service.
          </p>
        </>
      ),
    },
    {
      ...
      answer: (
        <>
          <p>
            Yes. Every VA loan has a one-time funding fee that's paid to the
            Department of Veterans Affairs. The fee supports the VA loan
            program.
          </p>
        </>
      ),
    ...
    {
      question: "I've heard VA loan appraisals are stricter? Is that true?",
      answer: (
        <>
          <p>
            Yes, VA appraisals are typically very thorough. That's because the
            Department of Veterans Affairs wants to make sure its service
            members and veterans are getting a good home.
          </p>
        </>
      ),
    },
  ...
  return (
    <Layout headerHasBorder={true}>
      <SearchEngineOptimization
        title="VA Loans Chicago | MacAsh Home Loans"
        description="No money down. No PMI. Competitive interest rates. Apply for a VA loan today from MacAsh and get the keys for your new Chicago area home in just 15 days."
        ...
        <div className="container">
          <div className="grid md:grid-cols-12 md:gap-x-5 lg:gap-x-10 gap-y-8 items-center">
            <div className="relative z-20 md:col-start-1 md:col-span-5">
              <h1>VA Loans In Chicago</h1>
              <p className="font-display italic text-xl md:text-2xl">
                If you're a U.S. military service member or veteran dreaming of
                owning a home in Chicago, then a VA loan is your ticket.
              </p>
      ...
      <section className="mb-20 md:mb-32">
        <div className="container">
          <header className="mb-10 md:mb-12">
            <h2>The Benefits Of A VA Loan</h2>
          </header>
          ...
          <div className="grid md:grid-cols-2 gap-y-10 md:gap-y-16 md:gap-x-10 lg:gap-x-20">
            <div className="flex items-center space-x-4 md:space-x-8">
              ...
              <div>
                ...
                <p className="mb-0">
                  This is the biggest benefit of the VA loan—the ability to buy
            ...
            <div className="flex items-center space-x-4 md:space-x-8">
              ...
              <div>
                ...
                <p className="mb-0">
                  Because the loan is backed by the Veterans Administration,
                  there's no need for private mortgage insurance.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4 md:space-x-8">
              ...
              <div>
                ...
                <p className="mb-0">
                  ...
                  which can save you on your monthly mortgage payment.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-4 md:space-x-8">
              ...
              <div>
                ...
                <p className="mb-0">
                  You don't need perfect credit to take advantage of a VA loan.
                  The minimums are typically lower than conventional loans.
                </p>
              </div>
            </div>
          </div>
...
export const query = graphql`
  {
    openGraphImage: file(
      relativePath: { eq: "open-graph/facebook/VALoan.jpg" }
    ) {
      publicURL
    }
    twitterOpenGraphImage: file(
      relativePath: { eq: "open-graph/twitter/VALoan.jpg" }
    ) {
      publicURL
    }
    heroDesktop: file(relativePath: { eq: "6.0 VA/1.0 Hero.jpg" }) {
      childImageSharp {
        gatsbyImageData(layout: CONSTRAINED, width: 920)
      }
    }
    doIQuality: file(relativePath: { eq: "6.0 VA/do-i-qualify.jpg" }) {
      childImageSharp {
