  ...
  return (
    <Layout headerDarkMode={true}>
      <SearchEngineOptimization
        title="Northbrook Mortgage Lender | Home Loans | MacAsh"
        description="Apply online. Close in 15 days. It's that easy. Make your dream home a reality with MacAsh, your independent mortgage broker in Northbrook and northern Illinois."
          ...
          <div className="grid md:grid-cols-12 gap-y-8 md:gap-x-10 lg:gap-x-16 items-center">
            <div className="md:col-start-1 md:col-span-7">
              <GatsbyImage
                ...
                alt="Northbrook Home Loans"
              />
            </div>
            <div className="md:col-end-13 md:col-span-5">
              <h1>Northbrook Home Loans</h1>
              <p className="font-display italic text-xl md:text-2xl">
                ...
                lender in Northbrook and northern Illinois.
              </p>
              <ButtonGhost
                href="/about/"
                text="Learn More"
            ...
            <div className="md:mt-10 lg:mt-28">
              <div>
                ...
                <p className="font-display italic text-lg md:text-2xl">
                  ...
                  in Northbrook, get started with MacAsh. We make it quick and
                  easy.
                </p>
                <div>
                  <ButtonGhost
      ...
      <section className="mb-20 md:mb-32">
        <div className="container">
          <div className="grid md:grid-cols-2 gap-y-8 md:gap-x-10 lg:gap-x-20 items-center">
            <div>
              <h2>The Northbrook Life</h2>
              <p className="mb-0">
                At MacAsh, we make our home in northern Illinois and are proud
                to be a local mortgage broker in Northbrook. This
                family-friendly Chicago suburb is often ranked as one of
                Illinois's best places to live. Parents are attracted to the
                community's highly rated schools, and its proximity to downtown
                Chicago appeals to professionals and entrepreneurs. Northbrook
                is a great place to put your roots down, and we're happy to help
                you land your dream home here in Illinois.
              </p>
            </div>
            <div>
              <GatsbyImage
                image={data.city.childImageSharp.gatsbyImageData}
                alt="The Northbrook Life"
              />
            </div>
          </div>
        </div>
...
export const query = graphql`
  {
    ...
    city: file(relativePath: { eq: "cities/Northbrook.jpg" }) {
      childImageSharp {
        gatsbyImageData(layout: CONSTRAINED, width: 560)
      }
    }
